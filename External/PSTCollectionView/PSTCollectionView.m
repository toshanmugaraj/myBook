...
@property (strong, nonatomic, readonly) id currentUpdate;
@property (strong, nonatomic, readonly) NSDictionary *visibleViewsDict;
...
-(CGRect)getScrolltoRect:(NSIndexPath *)indexPath {
    [self layoutSubviews];
    ...
    if (layoutAttributes) {
        CGRect targetRect = [self makeRect:layoutAttributes.frame toScrollPosition:PSTCollectionViewScrollPositionTop];
        return targetRect;
    }
    return CGRectNull;
}
